...
public class Graph {
	...
	public static void main(String[] args) {
		Graph web = new Graph();
		web.addEdge(new Vertex(3,1), Vertex.Direction.north, new Vertex(2,1));
		web.addEdge(new Vertex(1,0), Vertex.Direction.south, new Vertex(5,0));
		web.addEdge(new Vertex(2,0), Vertex.Direction.east, new Vertex(6,0));
